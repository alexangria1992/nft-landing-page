  ...
  return (
    <div className="bg-red-600">
      ...
      >
        {data.map((item) => {
          return (
            <div className="flex items-center gap-3 mr-12 cursor-pointer hover:scale-105 transition-all bg-green-900">
              <img
                src={`/img/${item.image}`}
                alt=""
      ...
      >
        {data.map((item) => {
          return (
            <div className="flex items-center gap-3 mr-4 md:mr-12 cursor-pointer hover:scale-105 transition-all bg-green-900">
              <img
                src={`/img/${item.image}`}
                alt=""
                className="rounded-full w-1/4 md:w-auto"
