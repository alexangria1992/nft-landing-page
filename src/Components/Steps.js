...
export default function Steps() {
  return (
    <>
      <div className="container mx-auto py-20 px-3 md:px-0 bg-lime-400">
        <h1 className="font-primary text-tertiary font-bold text-3xl md:text-6xl text-center mb-0 md:mb-8">
          Create and sell your NFT's
        </h1>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-14 py-8 bg-amber-600 ">
          <div className="bg-primary text-tertiary text-center rounded-2xl border-tertiary w-full p-3 md:p-4 flex flex-col items-center gap-3 cursor-pointer hover:scale-105 transition-all">
          ...
          <div className="bg-primary text-tertiary text-center rounded-2xl border-tertiary w-full p-3 md:p-4 flex flex-col items-center gap-3 cursor-pointer hover:scale-105 transition-all col-span-2 md:col-span-1">
